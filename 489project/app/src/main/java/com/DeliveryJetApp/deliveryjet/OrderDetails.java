...
public class OrderDetails extends Activity {
    private TextView orderIdTF,customerNameTF,customerEmailTF,addressTF,phoneTF,weightTF,dateTF,detailsTF,comNameTF,comEmailTF,comAddressTF,comPhoneTF;
    ...
    private  void saveCode(String key,String delEmail){
        ...
        if(val!= null) {
            ...
            if (errorMSG.isEmpty()) {
                String value = orderId + ";" + email + ";" + details + ";" + weight + ";" + customerName + ";" +customerEmail + ";" + phone + ";" + address + ";" + date + ";" + "Delivered"+";"+code+";"+delEmail;
